...
class AppColors {
  ...
  static const Color white = Color(0xFFFFFFFF);
    static const Color moveColor = Color(0xff180B37);
        static const Color greentow = Color(0xff18392B);
        static const Color coloBackHadith1 = Color(0xffC1DBD4);
        static const Color coloBackHadith2 = Color(0xff90B0A8);
  ...
  static const Color redDark = Color(0xFF923131);
     static Color greenOpacity = Color(0xff029D65);
    static const Color bluecolor = Color(0xff386DB3);
    static const Color bluecolorobacity = Color(0xff91AFD5);

    static const Color green = Color(0xff14AD6C);
    
    }
    

Color kButtonColor = kButtonColors[0];
Color kBackgroundColor = kBackgroundColors[0];
Color kElementsColor = kElementsColors[0];
Color kLightElementColor = kLightElementColors[0];
Color kTextColor = kTextColors[0];

const List kButtonColors = [
  Color(0xffECB365),
  Color(0xff404040),
  Color(0xffA1CCD1),
  Color(0xff44746c),
...
const List kLightElementColors = [
  Color(0xff041C32),
  Color(0xff0D0D0D),
  Color(0xff0D0D0D),
  Color(0xff112b23),
